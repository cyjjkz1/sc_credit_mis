...
POST_detail = RequiredField('detail', converter=converter.TypeConverter(str), checker=ReChecker(r'.{10,200}'))
...
POST_audit_department_id = RequiredField('audit_department_id', converter=converter.TypeConverter(str), checker=ReChecker(r'[0-9]{1,}'))
